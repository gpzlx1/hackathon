...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        getOperatorInfo: function (operatorId) {
            return this.getData().operators[operatorId].properties.information;
        },

        setOperatorInfo: function (operatorId, NewInfo) {
            var data = this.getData();
            data.operators[operatorId].properties.information = NewInfo;
            this.setData(data);
        },
